...
file_saving_format = 'png' # supports png, jpeg, pdf, svg (recommended)
...
version = '1.1.0'
list_of_tools = ['Planet Radius Calculator','Star Image Retrieval', 'Star Light Curve Retrieval', 'Star Light Curve Bulk Retrieval']
