...
version = '1.4.0'
list_of_tools = ['Exoplanet Radius Calculator','Star Pixelfile Retrieval', 'Star Light Curve Retrieval', 'Star Habitable Zone Calculator', 'Stefan-Boltzmann Star Temperature Calculator', 'Kepler Orbital Radius Calculator']
